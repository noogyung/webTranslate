...
## 💖 후원 정책 (Donation & Sponsorship)

Web Translator는 사용자의 쾌적한 다국어 웹서핑을 위해 지속적으로 유지보수되고 있습니다.

* **무료 제공 원칙**: 모든 핵심 기능은 후원 여부와 무관하게 전면 무료로 제공됩니다.
* **후원금 사용처**: 테스트용 AI API 크레딧, 개발자 계정 유지비, 인프라 및 오픈소스 고도화 비용으로 투명하게 사용됩니다.
* **후원자 혜택**: 프로젝트 `README` 및 옵션 페이지의 후원자 명단 등재, 차기 기능 베타 테스트 우선 참여 등.
